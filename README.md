...
The aims of this image is to be used as a base for your own Docker images. It's based on the awesome work of: [phusion/baseimage-docker](https://github.com/phusion/baseimage-docker)
